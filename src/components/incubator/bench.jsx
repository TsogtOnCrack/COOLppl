...
export const Bench = (props) => {
  ...
  return (
    <div className={` min-h-[650px] h-fit flex-col md:flex-row justify-end flex `}>
      <div className="absolute block md:hidden mb-60 opacity-70  ">
      ...
      <div className="absolute right-[calc(50%)] hidden md:block ">
      ...
      <div className="absolute right-[calc(50%+50px)] mt-60 hidden md:block">
